  ...
  <div id='page-wrap'>
	...
	<?php  
		...
		$Numero=$Numero +1;
			...
			$sql="INSERT INTO preguntas VALUES ('$Numero','$_POST[correo]','$_POST[pregunta]','$_POST[correcta]','$_POST[incorrecta1]','$_POST[incorrecta2]','$_POST[incorrecta3]','$_POST[tema]','$_POST[complejidad]')";
